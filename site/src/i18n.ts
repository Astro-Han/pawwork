...
export const I18N: Record<Lang, Dict> = {
  en: {
    ...
    desc: "Free, open-source AI desktop app for macOS and Windows, built on DeepSeek Harness. No terminal, no subscription — bring your own model key. An open alternative to Codex App and Claude Cowork.",
    brand: "PawWork",
    "nav.feat": "What it does",
    tag: "Open-source, free to use",
    h1: 'Real work, done on your <span class="o">desktop</span>',
    sub: "<b>No terminal. No subscription. Your own model key.</b> Open PawWork, choose a folder, and ask in plain language.",
    ...
    "m.search": "Search providers",
    "m.pick": "Connected",
    "m.ready": "IN USE",
    "m.foot": "Any provider the DSH model adapter supports",
    "c.h": "How PawWork compares",
    "c.hint": "Next to Codex App and Claude Desktop (Cowork).",
    "c.claude": "Claude Desktop",
    "c.r1": "Open-source",
    "c.r4": "App free, no subscription",
    "c.r4pw": "Free, your key",
    "c.r4cx": "Limited",
    "c.r4cl": "Pro $20/mo",
    "c.r6": "Office files",
    yes: "Yes",
  ...
  cn: {
    ...
    desc: "免费开源的桌面 AI 工作助手，支持 macOS 和 Windows，基于 DeepSeek Harness 构建。不用终端、不用订阅，模型 Key 自备。Codex App 和 Claude Cowork 的开源替代。",
    brand: "爪印",
    "nav.feat": "功能",
    tag: "开源，下载即用",
    h1: '真能<span class="o">干活</span>，跑在你电脑上',
    sub: "<b>不用终端，不用订阅，模型 Key 自备。</b>打开爪印，选个文件夹，说一声就行。",
    "dl.mac.t": "下载 macOS 版",
    "dl.mac.s": "Apple 芯片",
    "dl.intel.t": "macOS",
    "dl.intel.s": "Intel",
