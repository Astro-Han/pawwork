...
// Slice 11b.1: task / agent renderer extracted to
// `./message-part-tools-agent`. Side-effect import registers both names.
import "./message-part-tools-agent"

// Slice 11b.1: bash renderer extracted to `./message-part-tools-shell`.
