...
import { MessageMarkdown, PacedMarkdown } from "./message-part-markdown"
import { PART_MAPPING } from "./message-part-registry"

/**
 * Slice 11b.1: text / reasoning / compaction part renderers extracted
 * from `message-part.tsx`.
 *
 *   `MessageDivider`          horizontal divider with centered label;
 *                             also rendered standalone from
 *                             session-turn.tsx for turn-change banners,
 *                             which is why it's exported (not just a
 *                             local helper of the compaction renderer).
 *   side-effect               assigns
 *                                 PART_MAPPING["compaction"]
 *                                 PART_MAPPING["text"]
 *                                 PART_MAPPING["reasoning"]
 *                             importing this module is required for the
 *                             registry to know about these three parts.
 *
 * Pure cycle-free import set: pulls from the markdown helper + registry,
 * never from this file's tool renderers.
 */
