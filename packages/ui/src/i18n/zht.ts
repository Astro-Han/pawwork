...
export const dict = {
  ...
  "ui.sessionTurn.retry.recoveryAttempt": "正在恢復…第 {{attempt}} 次",
  ...
  "ui.sessionTurn.status.connecting": "連線中",
  ...
  "ui.tool.browser.navigate": "打開頁面",
  "ui.tool.browser.snapshot": "讀取頁面結構",
  "ui.tool.browser.click": "點擊",
  "ui.tool.browser.type": "輸入",
  "ui.tool.browser.wait": "等待頁面",
  "ui.tool.browser.screenshot": "截圖",
  "ui.tool.browser.extract": "擷取頁面內容",
  "ui.tool.shell": "Shell",
  "ui.tool.patch": "修改檔案",
  "ui.tool.todos": "待辦",
  ...
  "ui.errorCard.detail": "詳情",
  "ui.errorCard.auth.title": "登入已失效",
  "ui.errorCard.auth.body": "模型服務拒絕了這次請求，通常是金鑰過期或權限變更。重新登入後可以繼續。",
  "ui.errorCard.auth.action": "重新登入",
  "ui.errorCard.quota_exhausted.title": "餘額不足",
  "ui.errorCard.quota_exhausted.body": "這個模型的帳戶餘額或額度已經用完。到對應服務商儲值後可以重試，或者換一個模型繼續。",
  "ui.errorCard.quota_exhausted.action": "換個模型",
  "ui.errorCard.invalid_request.title": "請求無法處理",
  "ui.errorCard.invalid_request.body": "模型服務沒有接受這次請求，可能是所選模型不可用，或對話內容超出限制。",
  "ui.errorCard.invalid_request.action": "換個模型",
  "ui.errorCard.rate_limit.title": "請求過於頻繁",
  "ui.errorCard.rate_limit.body": "短時間內請求太多，稍等片刻通常會自動恢復。",
  "ui.errorCard.server_overload.title": "伺服器繁忙",
  "ui.errorCard.server_overload.body": "模型服務暫時過載，稍等再試通常就能恢復。",
  "ui.errorCard.transport_disconnect.title": "連線中斷",
  "ui.errorCard.transport_disconnect.body": "與模型的連線中斷了，回覆沒有完成。網路或服務可能不穩定，可以重新傳送。",
  "ui.errorCard.decompression.title": "回應異常",
  "ui.errorCard.decompression.body": "收到的資料無法正常讀取，重新傳送一次通常就能恢復。",
  "ui.errorCard.unknown.title": "無法完成",
