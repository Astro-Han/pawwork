...
export const dict = {
  ...
  "ui.sessionTurn.trow.summary.browser.one": "浏览器操作 {{count}} 步",
  "ui.sessionTurn.trow.summary.browser.other": "浏览器操作 {{count}} 步",
  ...
  "ui.tool.browser.navigate": "打开页面",
  "ui.tool.browser.snapshot": "读取页面结构",
  "ui.tool.browser.click": "点击",
  "ui.tool.browser.type": "输入",
  "ui.tool.browser.wait": "等待页面",
  "ui.tool.browser.screenshot": "截图",
  "ui.tool.browser.extract": "提取页面内容",
  ...
  "ui.errorCard.detail": "详情",
  "ui.errorCard.auth.title": "登录已失效",
  "ui.errorCard.auth.body": "模型服务拒绝了这次请求，通常是密钥过期或权限变更。重新登录后可以继续。",
  "ui.errorCard.auth.action": "重新登录",
  "ui.errorCard.quota_exhausted.title": "余额不足",
  "ui.errorCard.quota_exhausted.body": "这个模型的账户余额或额度已经用完。到对应服务商充值后可以重试，或者换一个模型继续。",
  "ui.errorCard.quota_exhausted.action": "换个模型",
  "ui.errorCard.invalid_request.title": "请求无法处理",
  "ui.errorCard.invalid_request.body": "模型服务没有接受这次请求，可能是所选模型不可用，或对话内容超出限制。",
  "ui.errorCard.invalid_request.action": "换个模型",
  "ui.errorCard.rate_limit.title": "请求过于频繁",
  "ui.errorCard.rate_limit.body": "短时间内请求太多，稍等片刻通常会自动恢复。",
  "ui.errorCard.server_overload.title": "服务器繁忙",
  "ui.errorCard.server_overload.body": "模型服务暂时过载，稍等再试通常就能恢复。",
  "ui.errorCard.transport_disconnect.title": "连接中断",
  "ui.errorCard.transport_disconnect.body": "与模型的连接断开了，回复没有完成。网络或服务可能不稳定，可以重新发送。",
  "ui.errorCard.decompression.title": "响应异常",
  "ui.errorCard.decompression.body": "收到的数据无法正常读取，重新发送一次通常就能恢复。",
  "ui.errorCard.unknown.title": "无法完成",
