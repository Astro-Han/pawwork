...
export const dict = {
  ...
  "ui.sessionTurn.turnChanges.undo": "全部撤销",
  "ui.sessionTurn.turnChanges.undoConfirm": "全部撤销？",
  "ui.sessionTurn.turnChanges.redo": "全部重新应用",
  "ui.sessionTurn.turnChanges.redoConfirm": "全部重新应用？",
