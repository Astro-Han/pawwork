 ...
 *
 * Scope: all UI CSS that ships to the browser. Comment-only matches (e.g.
 * doc strings explaining the convention) are tolerated; we only check
 * `@media` blocks that actually open a rule.
 */
