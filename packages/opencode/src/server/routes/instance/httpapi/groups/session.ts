...
const operation = (identifier: string) => OpenApi.annotations({ identifier })
  ...
  .add(
    HttpApiGroup.make("session")
      .add(
        ...
        }).annotateMerge(operation("session.create")),
        HttpApiEndpoint.get("status", SessionPaths.status, {
          query: WorkspaceRoutingQuery,
          success: Schema.Record(Schema.String, Schema.Any),
          error: BadRequestError,
        }).annotateMerge(operation("session.status")),
        ...
        HttpApiEndpoint.get("get", SessionPaths.get, {
          ...
          success: Schema.Any,
          error: [BadRequestError, NotFoundError],
        }).annotateMerge(operation("session.get")),
        HttpApiEndpoint.patch("update", SessionPaths.update, {
          ...
          success: Schema.Any,
          error: [BadRequestError, NotFoundError],
        }).annotateMerge(operation("session.update")),
        HttpApiEndpoint.delete("remove", SessionPaths.remove, {
          params: SessionParam,
          query: WorkspaceRoutingQuery,
          success: Schema.Boolean,
          error: [BadRequestError, NotFoundError],
        }).annotateMerge(operation("session.delete")),
        HttpApiEndpoint.get("children", SessionPaths.children, {
          params: SessionParam,
          query: WorkspaceRoutingQuery,
          success: Schema.Array(Schema.Any),
          error: [BadRequestError, NotFoundError],
        }).annotateMerge(operation("session.children")),
        HttpApiEndpoint.post("init", SessionPaths.init, {
          ...
          success: Schema.Boolean,
          error: [BadRequestError, NotFoundError],
        }).annotateMerge(operation("session.init")),
        HttpApiEndpoint.get("messages", SessionPaths.messages, {
          params: SessionParam,
          query: SessionMessagesQuery,
          success: Schema.Array(Schema.Any),
          error: [BadRequestError, NotFoundError],
        }).annotateMerge(operation("session.messages")),
        HttpApiEndpoint.post("prompt", SessionPaths.prompt, {
          ...
          success: Schema.Any,
          error: [BadRequestError, NotFoundError],
        }).annotateMerge(operation("session.prompt")),
        HttpApiEndpoint.get("message", SessionPaths.message, {
          params: MessageParam,
          query: WorkspaceRoutingQuery,
          success: Schema.Any,
          error: [BadRequestError, NotFoundError],
        }).annotateMerge(operation("session.message")),
        HttpApiEndpoint.delete("messageRemove", SessionPaths.messageRemove, {
          params: MessageParam,
          query: WorkspaceRoutingQuery,
          success: Schema.Boolean,
          error: [BadRequestError, NotFoundError, ConflictError],
        }).annotateMerge(operation("session.deleteMessage")),
        HttpApiEndpoint.patch("partUpdate", SessionPaths.partUpdate, {
          ...
          success: Schema.Any,
          error: [BadRequestError, NotFoundError],
        }).annotateMerge(operation("part.update")),
        HttpApiEndpoint.delete("partRemove", SessionPaths.partRemove, {
          params: PartParam,
          query: WorkspaceRoutingQuery,
          success: Schema.Boolean,
          error: [BadRequestError, NotFoundError],
        }).annotateMerge(operation("part.delete")),
        HttpApiEndpoint.get("todo", SessionPaths.todo, {
          params: SessionParam,
          query: WorkspaceRoutingQuery,
          success: Schema.Any,
          error: [BadRequestError, NotFoundError],
        }).annotateMerge(operation("session.todo")),
        HttpApiEndpoint.post("promptAsync", SessionPaths.promptAsync, {
          ...
          success: Schema.Void,
          error: [BadRequestError, NotFoundError],
        }).annotateMerge(operation("session.prompt_async")),
        HttpApiEndpoint.post("abort", SessionPaths.abort, {
          params: SessionParam,
          query: SessionAbortQuery,
          success: Schema.Boolean,
          error: [BadRequestError, NotFoundError],
        }).annotateMerge(operation("session.abort")),
        HttpApiEndpoint.post("command", SessionPaths.command, {
          ...
          success: Schema.Any,
          error: [BadRequestError, NotFoundError],
        }).annotateMerge(operation("session.command")),
        HttpApiEndpoint.post("fork", SessionPaths.fork, {
          ...
          success: Schema.Any,
          error: [BadRequestError, NotFoundError],
        }).annotateMerge(operation("session.fork")),
        HttpApiEndpoint.get("diff", SessionPaths.diff, {
          params: SessionParam,
          query: SessionDiffQuery,
          success: Schema.Any,
        }).annotateMerge(operation("session.diff")),
        HttpApiEndpoint.post("share", SessionPaths.share, {
          params: SessionParam,
          query: WorkspaceRoutingQuery,
          success: Schema.Any,
          error: [BadRequestError, NotFoundError, GoneError],
        }).annotateMerge(operation("session.share")),
        HttpApiEndpoint.delete("unshare", SessionPaths.unshare, {
          params: SessionParam,
          query: WorkspaceRoutingQuery,
          success: Schema.Any,
          error: [BadRequestError, NotFoundError, GoneError],
        }).annotateMerge(operation("session.unshare")),
        HttpApiEndpoint.post("summarize", SessionPaths.summarize, {
          ...
          success: Schema.Boolean,
          error: [BadRequestError, NotFoundError, ConflictError],
        }).annotateMerge(operation("session.summarize")),
        HttpApiEndpoint.post("shell", SessionPaths.shell, {
          ...
          success: Schema.Any,
          error: [BadRequestError, NotFoundError, ConflictError],
        }).annotateMerge(operation("session.shell")),
        HttpApiEndpoint.post("revert", SessionPaths.revert, {
          ...
          success: Schema.Any,
          error: [BadRequestError, NotFoundError, ConflictError],
        }).annotateMerge(operation("session.revert")),
        HttpApiEndpoint.post("unrevert", SessionPaths.unrevert, {
          params: SessionParam,
          query: WorkspaceRoutingQuery,
          success: Schema.Any,
          error: [BadRequestError, NotFoundError, ConflictError],
        }).annotateMerge(operation("session.unrevert")),
        HttpApiEndpoint.post("permission", SessionPaths.permission, {
          ...
          success: Schema.Boolean,
          error: [BadRequestError, NotFoundError],
        }).annotateMerge(operation("permission.respond")),
        HttpApiEndpoint.get("artifacts", SessionPaths.artifacts, {
          params: SessionParam,
          query: WorkspaceRoutingQuery,
          success: Schema.Array(Schema.Any),
        }).annotateMerge(operation("session.artifacts")),
        HttpApiEndpoint.get("export", SessionPaths.export, {
          params: SessionParam,
          query: WorkspaceRoutingQuery,
          success: Schema.Any,
          error: [BadRequestError, NotFoundError],
        }).annotateMerge(operation("session.export")),
        ...
        HttpApiEndpoint.get("aggregateChanges", SessionPaths.aggregateChanges, {
          ...
          success: Schema.Any,
          error: [BadRequestError, NotFoundError],
        }).annotateMerge(operation("session.turnChangesAggregate")),
        HttpApiEndpoint.post("aggregateUndo", SessionPaths.aggregateUndo, {
          ...
          success: Schema.Any,
          error: [BadRequestError, NotFoundError, ConflictError],
        }).annotateMerge(operation("session.turnChangesAggregateUndo")),
        HttpApiEndpoint.post("aggregateRedo", SessionPaths.aggregateRedo, {
          ...
          success: Schema.Any,
          error: [BadRequestError, NotFoundError, ConflictError],
        }).annotateMerge(operation("session.turnChangesAggregateRedo")),
      )
      .annotateMerge(
        OpenApi.annotations({
          title: "session",
