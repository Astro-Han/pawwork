...
function fake(
  ...
  return {
    ...
    completeToolExecution: Effect.fn("TestSessionProcessor.completeToolExecution")(() => Effect.void),
    failToolExecution: Effect.fn("TestSessionProcessor.failToolExecution")(() => Effect.void),
    recordToolInputCaptured: Effect.fn("TestSessionProcessor.recordToolInputCaptured")(() => Effect.void),
    recordToolExecutionStarted: Effect.fn("TestSessionProcessor.recordToolExecutionStarted")(() => Effect.void),
    recordToolExecutionCompleted: Effect.fn("TestSessionProcessor.recordToolExecutionCompleted")(() => Effect.void),
    recordToolExecutionFailed: Effect.fn("TestSessionProcessor.recordToolExecutionFailed")(() => Effect.void),
