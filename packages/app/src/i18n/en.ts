export const dict = {
  ...
  "remote.platform.feishu": "Feishu / Lark",
  ...
  "remote.wechat.note":
    "WeChat connects through Tencent's official iLink (released March 2026): scan to connect, local long-poll, no relay we run — the same shape as Telegram. Its one limit is reply-only — it can't message you unprompted — which matches the design here: your phone starts a turn, the agent replies, nothing buzzes you unasked.",
  ...
  "remote.connect.feishu.title": "Connect Feishu / Lark",
  ...
  "remote.connect.qr.feishu.title": "Scan to authorize",
  "remote.connect.qr.feishu.body":
    "Open Feishu or Lark and use Scan. Authorizing creates a bot for you automatically — no developer console, and it detects Feishu vs Lark on its own.",
  ...
  "remote.connect.qr.fallback": "Can't scan? Open this link on your phone:",
  ...
  "remote.connect.bind.group.title": "Add the bot to a group",
  "remote.connect.bind.group.body":
    "Add the new bot to a group chat and @mention it once. That group becomes the bound channel.",
