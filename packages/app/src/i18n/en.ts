export const dict = {
  ...
  "settings.memory.delete.title": "Delete entry by id",
  "settings.memory.delete.description": "Deletes only the matching Archive entry.",
  "settings.memory.delete.done": "Memory entry deleted",
