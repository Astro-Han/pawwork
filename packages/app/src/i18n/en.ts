export const dict = {
  ...
  "settings.remote.description":
    "Message your agent from a chat app on your phone. Your computer connects out — no public address or server setup.",
  ...
  "settings.remote.connect.confirm.title": "Allow this account?",
  "settings.remote.connect.confirm.body":
    "{{name}} will be able to send prompts and answer permission requests in your agent sessions. Only allow yourself.",
  "settings.remote.connect.action.allow": "Allow",
  "settings.remote.connect.toast.title": "Telegram connected",
  "settings.remote.connect.toast.body": "You can now message your agent from Telegram.",
  "settings.remote.disconnect.title": "Disconnect Telegram?",
  "settings.remote.disconnect.body":
    "This removes the saved bot token from this computer. You can connect again any time.",
