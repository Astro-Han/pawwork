export const dict = {
  ...
  "prompt.attachment.unsupported.image":
    "This model can't view images, so it won't see this one. Switch models to share it.",
  "prompt.attachment.unsupported.pdf":
    "This model can't read PDFs, so it won't see this file. Switch models to share it.",
  ...
  "automations.toast.failureStreak.description":
    "“{{title}}” has failed {{count}} times in a row. Open Automations to check it.",
  ...
  "automations.create.viaChatPrompt":
    "Help me set up an automation. Ask me what it should do and when it should run, then create it.",
  ...
  "automations.template.dailyBrief.prompt":
    "Summarize what needs my attention today: progress, open tasks, risks, and decisions to make. Keep it to a short list of bullet points.",
  "automations.template.weeklyReview.title": "Weekly review",
  "automations.template.weeklyReview.prompt":
    "Review the past week: what shipped, what progressed, what's blocked, and the top priorities to focus on next week.",
  "automations.template.projectMonitor.title": "Project monitor",
  "automations.template.projectMonitor.prompt":
    "Check this project's latest state: new issues, failing checks, or anything unusual. Call out what needs attention in bullets, or confirm all clear.",
  ...
  "settings.remote.description": "Connect a chat platform to this desktop PawWork session.",
  "settings.remote.section.config": "Configuration",
  "settings.remote.section.status": "Status",
  "settings.remote.platform.title": "Platform",
  "settings.remote.platform.description": "Choose the chat platform to connect.",
  "settings.remote.options.title": "Raw options (JSON)",
  "settings.remote.options.invalid": "Enter a JSON object.",
  "settings.remote.required": "Fill the required fields marked with *.",
  "settings.remote.status.title": "Bridge",
  "settings.remote.status.description": "Configure a platform, then start the bridge.",
  "settings.remote.status.ready": "Bridge is running. Open the configured chat and send /help.",
  "settings.remote.status.running": "Running",
  "settings.remote.status.starting": "Starting",
  "settings.remote.status.error": "Error",
  "settings.remote.status.idle": "Idle",
  "settings.remote.action.failed": "Remote access action failed",
  "settings.remote.action.save": "Save",
  "settings.remote.action.start": "Start",
  "settings.remote.action.stop": "Stop",
  "settings.remote.platform.feishu": "Feishu",
  ...
  "settings.remote.platform.weixin": "WeChat",
  "settings.remote.platform.qq": "QQ",
  "settings.remote.platform.qqbot": "QQ Bot",
  "settings.remote.platform.dingtalk": "DingTalk",
  "settings.remote.platform.wecom": "WeCom",
  "settings.remote.platform.wps-xiezuo": "WPS",
  ...
  "settings.remote.field.mode": "Mode",
  "settings.remote.field.ws_url": "OneBot WebSocket URL",
  "settings.remote.field.http_url": "OneBot HTTP URL",
  "settings.remote.field.allow_from": "Allowlist",
  "settings.remote.field.allow_chat": "Allowed chat",
  "settings.remote.field.group_only": "Group chats only",
  "settings.remote.field.allow_from.hint":
    "Only these user or channel IDs can reach the bridge. Leave empty to allow everyone.",
  "settings.remote.field.allow_chat.hint": "Restrict the bridge to a specific chat ID. Leave empty to allow everyone.",
  "settings.remote.field.group_only.hint": "Only respond inside group chats.",
  "settings.remote.field.mode.hint": "Connection mode, for example websocket.",
  "settings.remote.field.ws_url.hint":
    "Forward WebSocket of your OneBot client (NapCat, LLOneBot). Defaults to ws://127.0.0.1:3001.",
  "settings.remote.field.http_url.hint": "OneBot HTTP API, only needed for file transfers. For example http://127.0.0.1:3000.",
  ...
  "settings.memory.profileTooLarge":
    "Profile is larger than the v1 soft limit. Keep it short because it loads at session start.",
  "settings.memory.raw.title": "Raw MEMORY.md",
  "settings.memory.raw.description":
    "Profile loads at session start. Archive stays local and is searched only when needed.",
  ...
  "settings.worktrees.description":
    "Worktrees PawWork has created or registered. An active session keeps its worktree bound; run ExitWorktree before you can delete it.",
  ...
  "settings.general.webSearch.secondary.savedQuota":
    "The saved key quota is used; update the key or wait for Exa to reset it",
  ...
  "dialog.websearch.status.savedQuota":
    "The saved Exa key quota is used. Replace it, remove it, or wait for Exa to reset it.",
  ...
  "toast.websearch.savedQuota.description":
    "The saved Exa API key reached its search quota. Update or remove it in Settings.",
