export const dict = {
  ...
  "prompt.example.1": "Draft a project update email",
  "prompt.example.2": "Write a first-pass weekly update",
  "prompt.example.3": "Reply to a customer inquiry email",
  "prompt.example.4": "Draft a short product description",
  "prompt.example.5": "Write a polite decline to a meeting request",
  "prompt.example.6": "Summarize this Excel into a chart",
  "prompt.example.7": "Turn invoice data into a monthly report",
  "prompt.example.8": "Pull the key sales numbers from this spreadsheet",
  "prompt.example.9": "Compare two quarters of sales data",
  "prompt.example.10": "Clean up this CSV into a readable table",
  "prompt.example.11": "Merge these PDFs with a table of contents",
  "prompt.example.12": "Extract the key clauses from this contract",
  "prompt.example.13": "Split this PDF into separate chapters",
  "prompt.example.14": "Convert this Word document into PDF",
  "prompt.example.15": "Extract the text from this PDF report",
  "prompt.example.16": "Turn these meeting notes into minutes",
  "prompt.example.17": "Extract action items from the meeting notes",
  "prompt.example.18": "Turn these interview notes into an insights list",
  "prompt.example.19": "Break this memo into a task list",
  "prompt.example.20": "Rewrite this passage more concisely",
  "prompt.example.21": "Summarize this long document in a paragraph",
  "prompt.example.22": "Translate this Chinese memo into English",
  "prompt.example.23": "Extract the key takeaways from this article",
  "prompt.example.24": "Summarize this long email in a few sentences",
  "prompt.example.25": "Rewrite this technical document in plain English",
  ...
  "settings.memory.raw.description": "Profile updates in v1 are made here. Archive entries are searched only when needed.",
  ...
  "memory.review.title": "Remember this session?",
  "memory.review.placeholder": "Write one approved memory from this session...",
  "memory.review.accept": "Save memory",
  "memory.review.dismiss": "Dismiss",
  "memory.review.saved": "Memory saved",
  "memory.review.savedDescription": "Saved entry was re-read from MEMORY.md after redaction.",
  "memory.review.blocked": "Memory was not saved",
  "memory.review.blockedDisabled": "Memory is disabled.",
  "memory.review.blockedSafeMode": "Memory is in safe mode. Reset to template or fix MEMORY.md manually.",
