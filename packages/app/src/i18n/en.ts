export const dict = {
  ...
  "settings.worktrees.description": "Worktrees that PawWork has created or registered. Each session may bind to a worktree via the EnterWorktree tool; ExitWorktree releases the binding without deleting anything.",
  "settings.worktrees.empty": "No worktrees yet.",
