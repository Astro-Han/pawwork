...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "PawWork 提供的免费模型",
  ...
  "provider.connect.apiKey.description":
    "输入你的 {{provider}} API 密钥以连接帐户，并在 PawWork 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.code.visit.suffix": " 获取授权码，以连接你的帐户并在 PawWork 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix": " 并输入以下代码，以连接你的帐户并在 PawWork 中使用 {{provider}} 模型。",
  ...
  "prompt.toast.pathRequired.description": "PawWork 需要文件路径，才能让助手读取这个文件。请用附件按钮重新选择。",
  ...
  "dialog.server.description": "切换此应用连接的 PawWork 服务器。",
  ...
  "toast.update.description": "PawWork 有新版本 ({{version}}) 可安装。",
  ...
  "error.chain.mcpFailed": 'MCP 服务器 "{{name}}" 启动失败。注意: PawWork 暂不支持 MCP 认证。',
  ...
  "sidebar.gettingStarted.line1": "PawWork 提供免费模型，你可以立即开始使用。",
  ...
  "settings.desktop.wsl.description": "在 Windows 的 WSL 环境中运行 PawWork 服务器。",
  ...
  "settings.general.row.language.description": "更改 PawWork 的显示语言",
  "settings.general.row.appearance.title": "外观",
  "settings.general.row.appearance.description": "自定义 PawWork 在你的设备上的外观",
  "settings.general.row.colorScheme.title": "配色方案",
  "settings.general.row.colorScheme.description": "选择 PawWork 跟随系统、浅色或深色主题",
  "settings.general.row.theme.title": "主题",
  "settings.general.row.theme.description": "自定义 PawWork 的主题。",
  ...
  "settings.updates.row.startup.description": "在 PawWork 启动时自动检查更新",
