...
export const dict = {
  ...
  "sidebar.pawwork.automations": "自动化",
  ...
  "automations.delete.title": "删除自动化",
  "automations.delete.confirm": "删除“{{title}}”？",
  "automations.delete.description": "这会停止后续运行并移除该自动化。过往运行的会话会保留。",
  "automations.create.cta": "新建自动化",
  ...
  "automations.create.failed": "创建自动化失败",
