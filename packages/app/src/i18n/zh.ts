...
export const dict = {
  ...
  "provider.disconnect.toast.disconnected.deferredDescription":
    "{{provider}} 已断开连接。模型刷新会在当前任务结束后完成。",
  ...
  "context.stats.compactThreshold": "压缩阈值",
  ...
  "error.page.report.confirm.privacy":
    "诊断包可能包含会话内容、应用日志、本地路径和环境信息。不会自动上传你的原始项目文件。",
  ...
  "browser.closePage.description":
    "这个会话还有 agent 任务在运行，关闭页面会让它的浏览器操作失败，直到它重新打开网页。",
  ...
  "automations.template.dailyBrief.prompt":
    "汇总今天需要我关注的重点：进展、待办、风险和需要决策的事项，用简明的条目列出。",
  "automations.template.weeklyReview.title": "每周回顾",
  "automations.template.weeklyReview.prompt":
    "回顾过去一周：完成了什么、有哪些进展和阻塞，并给出下周建议优先处理的事项。",
  "automations.template.projectMonitor.title": "项目监控",
  "automations.template.projectMonitor.prompt":
    "检查这个项目的最新状态：新出现的问题、失败的检查或异常情况。有需要关注的就用要点列出，没有就说明一切正常。",
  ...
  "settings.remote.description": "将聊天平台连接到这台爪印。",
  "settings.remote.section.config": "配置",
  "settings.remote.section.status": "状态",
  "settings.remote.platform.title": "平台",
  "settings.remote.platform.description": "选择要连接的聊天平台。",
  "settings.remote.options.title": "原始选项（JSON）",
  "settings.remote.options.invalid": "请输入 JSON 对象。",
  "settings.remote.required": "请先填写标 * 的必填字段。",
  "settings.remote.status.title": "桥接",
  "settings.remote.status.description": "完成平台配置后，即可启动桥接。",
  "settings.remote.status.ready": "桥接运行中。前往已连接的聊天平台，发送 /help 即可。",
  "settings.remote.status.running": "运行中",
  "settings.remote.status.starting": "启动中",
  "settings.remote.status.error": "错误",
  "settings.remote.status.idle": "未启动",
  "settings.remote.action.failed": "远程访问失败",
  "settings.remote.action.save": "保存",
  "settings.remote.action.start": "启动",
  "settings.remote.action.stop": "停止",
  "settings.remote.platform.feishu": "飞书",
  "settings.remote.platform.lark": "Lark",
  "settings.remote.platform.slack": "Slack",
  "settings.remote.platform.discord": "Discord",
  "settings.remote.platform.telegram": "Telegram",
  "settings.remote.platform.line": "LINE",
  "settings.remote.platform.weixin": "微信",
  "settings.remote.platform.qq": "QQ",
  "settings.remote.platform.qqbot": "QQ 机器人",
  "settings.remote.platform.dingtalk": "钉钉",
  "settings.remote.platform.wecom": "企业微信",
  "settings.remote.platform.wps-xiezuo": "WPS 协作",
  "settings.remote.platform.max": "MAX",
  "settings.remote.field.app_id": "App ID",
  "settings.remote.field.app_secret": "App Secret",
  "settings.remote.field.client_id": "Client ID",
  "settings.remote.field.client_secret": "Client Secret",
  "settings.remote.field.token": "Token",
  "settings.remote.field.channel_secret": "Channel Secret",
  "settings.remote.field.channel_token": "Channel Access Token",
  "settings.remote.field.bot_token": "Bot Token",
  "settings.remote.field.app_token": "App Token",
  "settings.remote.field.bot_id": "Bot ID",
  "settings.remote.field.bot_secret": "Bot Secret",
  "settings.remote.field.mode": "连接模式",
  "settings.remote.field.ws_url": "OneBot WebSocket 地址",
  "settings.remote.field.http_url": "OneBot HTTP 地址",
  "settings.remote.field.allow_from": "白名单",
  "settings.remote.field.allow_chat": "允许的会话",
  "settings.remote.field.group_only": "仅群聊",
  "settings.remote.field.allow_from.hint": "只有这些用户或会话 ID 能访问桥接，留空表示不限制。",
  "settings.remote.field.allow_chat.hint": "仅允许指定会话 ID 访问桥接，留空表示不限制。",
  "settings.remote.field.group_only.hint": "仅在群聊中响应。",
  "settings.remote.field.mode.hint": "连接方式，例如 websocket。",
  "settings.remote.field.ws_url.hint": "OneBot 客户端（NapCat、LLOneBot）的正向 WebSocket 地址，默认 ws://127.0.0.1:3001。",
  "settings.remote.field.http_url.hint": "OneBot HTTP 接口，仅传文件时需要，例如 http://127.0.0.1:3000。",
  ...
  "settings.worktrees.description":
    "爪印创建或登记过的工作树。正在使用中的会话会保持绑定，先调用 ExitWorktree 才能删除。",
