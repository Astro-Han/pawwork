...
export const dict = {
  ...
  "automations.create.scheduleHeading": "日程",
  "automations.create.frequency.once": "跑一次",
  "automations.create.frequency.hourly": "每小时",
  "automations.create.frequency.daily": "每天",
  "automations.create.frequency.weekdays": "工作日",
  "automations.create.frequency.weekly": "每周",
  "automations.create.frequency.custom": "自定义",
