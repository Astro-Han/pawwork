...
export const dict = {
  ...
  "settings.remote.description": "在手机的聊天软件里和你的 agent 对话。电脑主动向外连接，不需要公网地址或服务器配置。",
  "settings.remote.section.telegram": "Telegram",
  ...
  "settings.remote.capabilities.title": "可以做什么",
  "settings.remote.capabilities.prompts": "发送指令，接收 agent 的回复",
  "settings.remote.capabilities.permissions": "批准或拒绝授权请求",
  "settings.remote.capabilities.sessions": "切换会话，或停止正在进行的运行",
  "settings.remote.action.connect": "连接",
  "settings.remote.action.disconnect": "断开",
  "settings.remote.connect.title": "连接 Telegram",
  "settings.remote.connect.token.label": "机器人 Token",
  "settings.remote.connect.token.placeholder": "123456789:ABCdef…",
  "settings.remote.connect.token.help": "在 Telegram 里用 @BotFather 创建一个机器人，把它给你的 Token 粘贴进来。Token 会加密保存在本机。",
  "settings.remote.connect.waiting.title": "给机器人发条消息",
  "settings.remote.connect.waiting.body": "在手机上打开 Telegram，给你的机器人发任意一条消息。第一个发消息的人会成为唯一能操控你 agent 的人。",
  "settings.remote.connect.confirm.title": "允许这个账号？",
  "settings.remote.connect.confirm.body": "{{name}} 将能在你的 agent 会话里发送指令、回应授权请求。只允许你自己。",
  "settings.remote.connect.action.allow": "允许",
  "settings.remote.connect.toast.title": "Telegram 已连接",
  "settings.remote.connect.toast.body": "现在可以在 Telegram 里和你的 agent 对话了。",
  "settings.remote.disconnect.title": "断开 Telegram？",
  "settings.remote.disconnect.body": "这会从本机删除已保存的机器人 Token。你随时可以重新连接。",
