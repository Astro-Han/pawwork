...
export const dict = {
  ...
  "remote.title": "远程控制",
  "remote.description": "用手机上的聊天工具，直接驱动这台桌面的智能体。电脑主动向外连接，不需要公网地址或服务器配置。",
  "remote.unsupported": "远程控制需要桌面应用。",
  "remote.channels.title": "渠道",
  "remote.platform.telegram": "Telegram",
  "remote.platform.feishu": "飞书 / Lark",
  ...
  "remote.wechat.note":
    "微信走腾讯官方 iLink（2026 年 3 月发布）：扫码连接、本地长轮询、不需要我们自建中转，和 Telegram 同构。唯一的限制是只能被动回复，不能主动给你发消息，这正好符合这里的设计：手机发起、智能体回复、不主动打扰。",
  "remote.capabilities.title": "连接后可以做什么",
  "remote.capabilities.prompts": "发送指令，接收智能体的回复",
  "remote.capabilities.permissions": "批准或拒绝授权请求",
  "remote.capabilities.sessions": "切换会话，或停止正在进行的运行",
  "remote.connect.telegram.title": "连接 Telegram",
  "remote.connect.feishu.title": "连接飞书 / Lark",
  ...
  "remote.connect.qr.feishu.title": "扫码授权",
  "remote.connect.qr.feishu.body": "用飞书或 Lark 的「扫一扫」。授权后会自动生成机器人，不需要开发者后台，也会自动识别飞书还是 Lark。",
  "remote.connect.qr.wechat.title": "扫码登录",
  "remote.connect.qr.wechat.body": "用微信「扫一扫」，然后在手机上确认。",
  "remote.connect.qr.fallback": "无法扫码？在手机上打开这个链接：",
  "remote.connect.bind.message.title": "给机器人发条消息",
  "remote.connect.bind.message.body": "在手机上给机器人发任意一条消息。第一个发消息的人会成为唯一能操控你智能体的人。",
  "remote.connect.bind.group.title": "把机器人拉进群",
  "remote.connect.bind.group.body": "把新生成的机器人拉进一个群聊，并 @它一下。这个群就成为绑定的渠道。",
  "remote.connect.confirm.title": "允许这个连接？",
  "remote.connect.confirm.body": "{{name}} 将能在你的智能体会话里发送指令、回应授权请求。只允许你自己。",
