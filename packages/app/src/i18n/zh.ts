...
export const dict = {
  ...
  "remote.title": "远程控制",
  "remote.description": "用手机上的聊天工具，远程操控这台电脑上的爪印。电脑主动向外连接，不需要公网地址或服务器配置。",
  ...
  "remote.connect.bind.message.note": "第一个发消息的人，会成为唯一能远程操控爪印的人。",
  ...
  "remote.connect.toast.body": "现在可以从 {{platform}} 远程操控爪印了。",
