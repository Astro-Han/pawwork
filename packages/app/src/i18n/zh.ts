...
export const dict = {
  ...
  "settings.remote.note": "配对使用你在 @BotFather 里创建的机器人。只有第一个给它发消息的人能操控你的 agent，Token 会加密保存在本机。",
  ...
  "settings.remote.connect.token.help": "在 Telegram 里用 @BotFather 创建一个机器人，把它给你的 Token 粘贴进来。",
