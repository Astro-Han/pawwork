...
export const dict = {
  ...
  "settings.general.homeSuggestions": "首页提示词建议",
  "settings.general.homeSuggestions.description": "新用户在首页 composer 下方显示 3 行提示词建议；点击预填到输入框",
  "settings.general.homeSuggestions.reset": "恢复全部建议",
