...
export const dict = {
  ...
  "prompt.placeholder.normal": '试试... "{{example}}"',
  "prompt.placeholder.simple": "试试...",
  ...
  "prompt.example.1": "起草一封项目进度邮件",
  "prompt.example.2": "写一份周报初稿给领导",
  "prompt.example.3": "回复这封客户咨询邮件",
  "prompt.example.4": "帮我写一段产品介绍文案",
  "prompt.example.5": "这封邮件怎么写才更礼貌？",
  "prompt.example.6": "把这份 Excel 汇总成图表",
  "prompt.example.7": "整理这份发票数据做成月报",
  "prompt.example.8": "从表格里提取销售要点",
  "prompt.example.9": "这份表格里哪个产品销售最好？",
  "prompt.example.10": "把 CSV 整理成易读的表格",
  "prompt.example.11": "合并几份 PDF 并生成目录",
  "prompt.example.12": "从合同里提取关键条款",
  "prompt.example.13": "把 PDF 拆成独立章节",
  "prompt.example.14": "把 Word 文档转成 PDF",
  "prompt.example.15": "这份 PDF 讲了什么？",
  "prompt.example.16": "把这段会议记录整理成纪要",
  "prompt.example.17": "从会议笔记里提取行动项",
  "prompt.example.18": "帮我把这段客户访谈整理成洞察清单",
  "prompt.example.19": "把这份备忘拆成任务清单",
  "prompt.example.20": "这段文字怎么改更简练？",
  "prompt.example.21": "给这篇长文写一段摘要",
  "prompt.example.22": "把这份英文报告翻译成中文",
  "prompt.example.23": "这篇文章的关键观点是什么？",
  "prompt.example.24": "把这封长邮件总结成几句话",
  "prompt.example.25": "把这份技术文档改写成通俗版",
  ...
  "session.new.placeholder.document": "把文档交给我，告诉我你想要整理、转换或提炼什么…",
  "session.new.placeholder.analysis": "把数据交给我，告诉我你想汇总、可视化或回答什么问题…",
  "session.new.placeholder.writing": "告诉我你想写什么，我来起草、润色或改写…",
  ...
  "settings.memory.safeMode": "记忆处于安全模式。原因：{{reason}}。请重置模板或手动修复文件。",
  "settings.memory.profileTooLarge": "Profile 超过 v1 建议大小。它会在会话启动时加载，建议保持很短。",
  "settings.memory.raw.title": "原始 MEMORY.md",
  "settings.memory.raw.description": "v1 中 Profile 更新通过这里手动编辑。Archive 只在需要时搜索。",
  "settings.memory.saved": "记忆已保存",
  "settings.memory.reset": "重置为模板",
  "settings.memory.resetConfirm": "这会覆盖 MEMORY.md。旧文件会先备份。继续吗？",
  "settings.memory.resetDone": "记忆已重置",
  "settings.memory.delete.title": "按 id 删除条目",
  "settings.memory.delete.description": "只删除匹配的 Archive 条目。",
  "settings.memory.delete.done": "记忆条目已删除",
  "memory.review.title": "要记住这次会话吗？",
  "memory.review.placeholder": "写一条本次会话确认要保存的记忆...",
  "memory.review.accept": "保存记忆",
  "memory.review.dismiss": "跳过",
  "memory.review.saved": "记忆已保存",
  "memory.review.savedDescription": "保存后已从 MEMORY.md 重新读取，敏感内容会被打码。",
