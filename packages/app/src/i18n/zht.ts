...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "PawWork 提供的免費模型",
  ...
  "provider.connect.apiKey.description":
    "輸入你的 {{provider}} API 金鑰以連線帳戶，並在 PawWork 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.code.visit.suffix": " 取得授權碼，以連線你的帳戶並在 PawWork 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " 並輸入以下程式碼，以連線你的帳戶並在 PawWork 中使用 {{provider}} 模型。",
  ...
  "dialog.plugins.empty": "在 pawwork.json 中設定的外掛程式",
  ...
  "dialog.server.description": "切換此應用程式連線的 PawWork 伺服器。",
  ...
  "toast.update.description": "PawWork 有新版本 ({{version}}) 可安裝。",
  ...
  "error.chain.checkConfig": "請檢查你的設定 (pawwork.json) 中的 provider/model 名稱",
  "error.chain.mcpFailed": 'MCP 伺服器 "{{name}}" 啟動失敗。注意: PawWork 暫不支援 MCP 認證。',
  ...
  "session.new.title": "從一個任務開始",
  "session.new.subtitle": "先選一個內建工作流程，再告訴 PawWork 你要完成什麼。",
  "session.new.card.document.title": "處理文件",
  "session.new.card.document.description": "編輯、轉換並擷取 Word、Excel、PowerPoint 與 PDF 檔案內容。",
  "session.new.card.analysis.title": "分析資料",
  "session.new.card.analysis.description": "彙總試算表、產出圖表，並回答檔案中的業務問題。",
  "session.new.card.writing.title": "開始寫作",
  "session.new.card.writing.description": "起草郵件、報告、方案與更成熟的工作文案。",
  ...
  "sidebar.gettingStarted.line1": "PawWork 提供免費模型，你可以立即開始使用。",
  ...
  "settings.desktop.wsl.description": "在 Windows 上的 WSL 中執行 PawWork 伺服器。",
  ...
  "settings.general.row.language.description": "變更 PawWork 的顯示語言",
  "settings.general.row.appearance.title": "外觀",
  "settings.general.row.appearance.description": "自訂 PawWork 在你的裝置上的外觀",
  "settings.general.row.colorScheme.title": "配色方案",
  "settings.general.row.colorScheme.description": "選擇 PawWork 要跟隨系統、淺色或深色主題",
  "settings.general.row.theme.title": "主題",
  "settings.general.row.theme.description": "自訂 PawWork 的主題。",
  ...
  "settings.updates.row.startup.description": "在 PawWork 啟動時自動檢查更新",
