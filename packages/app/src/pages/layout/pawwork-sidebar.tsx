      ...
      <div class="shrink-0 px-3 pt-3">
        <div class="flex flex-col gap-1">
          <button
            ...
            onClick={props.onNew}
            class="w-full flex items-center gap-2 pl-2 pr-3 py-1.5 rounded-md hover:bg-bg-cream focus-visible:bg-bg-cream transition-colors text-left focus:outline-none"
          >
            ...
            <nav class="flex flex-col gap-1">
              ...
              <Show when={props.sessionWindow().canShowMore}>
                <button
                  ...
                  class="mt-2 w-full rounded-md px-2 py-1.5 text-left text-13-regular text-fg-weak transition-colors hover:bg-bg-cream hover:text-fg-base focus:outline-none focus-visible:bg-bg-cream disabled:opacity-50"
                >
              ...
              <Show when={props.sessionWindow().capReached}>
                <button
                  ...
                  class="mt-2 w-full rounded-md px-2 py-1.5 text-left text-13-regular text-fg-weak transition-colors hover:bg-bg-cream hover:text-fg-base focus:outline-none focus-visible:bg-bg-cream"
                >
