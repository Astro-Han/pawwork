  ...
  return (
    <>
      <div
        ...
        class="group/session relative w-full min-w-0 rounded-md cursor-default pr-2 transition-colors hover:bg-surface-list-hover [&:has(:focus-visible)]:bg-surface-list-hover has-[[data-expanded]]:bg-surface-list-hover has-[.active]:bg-surface-interactive-base has-[.active]:hover:bg-surface-interactive-base"
...
export const NewSessionItem = (props: {
  ...
  return (
    <div class="group/session relative w-full min-w-0 rounded-md cursor-default transition-colors pl-2 pr-2 hover:bg-surface-list-hover [&:has(:focus-visible)]:bg-surface-list-hover has-[.active]:bg-surface-interactive-base has-[.active]:hover:bg-surface-interactive-base">
      {item}
    </div>
  )
}
