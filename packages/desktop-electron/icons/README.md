...
The script writes generated assets to `resources/icons/`, including `icon.icns`, `icon.ico`, Linux PNGs, Windows tile PNGs, Android launcher PNGs, and iOS AppIcon PNGs. `resources/icons/` is a build artifact and is ignored by git.
