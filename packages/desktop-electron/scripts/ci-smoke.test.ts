...
describe("ci smoke helpers", () => {
  ...
  const healthy: CiSmokeProductSnapshot = {
    ...
    sessionHeaderComposerColumnMismatch: { expanded: 0, collapsed: 0 },
    sessionHeaderDividerHidden: { expanded: true, collapsed: true },
    collapsedSessionContentAlignmentOffset: 0,
    collapsedSessionTabsGap: 8,
  ...
  const broken: Partial<Record<keyof CiSmokeProductSnapshot, unknown>> = {
    ...
    sessionHeaderComposerColumnMismatch: { expanded: 260, collapsed: 340 },
    sessionHeaderDividerHidden: { expanded: false, collapsed: false },
    collapsedSessionContentAlignmentOffset: 32,
    collapsedSessionTabsGap: -28,
