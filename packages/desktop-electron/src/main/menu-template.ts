...
const githubIssueUrl = "https://github.com/Astro-Han/pawwork/issues/new?template=01-bug-report.yml"
...
export function buildMenuTemplate(options: BuildMenuOptions): MenuItemTemplate[] {
  ...
  const helpSubmenu: MenuItemTemplate[] = [
    { label: t("pawworkOnGithub"), click: () => deps.openExternal("https://github.com/Astro-Han/pawwork") },
    { type: "separator" },
  ]
  ...
  helpSubmenu.push({ label: t("openGithubIssue"), click: () => deps.openExternal(githubIssueUrl) })
