...
test("round-trips a multi-platform account list", () => {
  ...
  const accounts: RemoteAccount[] = [
    ...
    { platform: "feishu", appId: "cli_x", appSecret: "sec", domain: "lark", allowChat: "oc_1" },
    { platform: "wechat", botToken: "tok", baseURL: "https://r2", allowFrom: "u@im.wechat" },
  ]
  store.save(accounts)
